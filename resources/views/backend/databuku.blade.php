    ...
    <body class="layout-default">
                                        ...
                                        <div class="navbar-notifications-menu__content"
                                            ...
                                            <div class="py-2">
                                                ...
                                                <div class="dropdown-item d-flex">
                                                    ...
                                                    <div class="flex">
                                                        <a href="">A.Demian</a> left a comment on <a href="">Perpustakaan</a><br>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active"
                                                aria-current="page">Data Buku</li>
                                        </ol>
                                    </nav>
        ...
        <div id="app-settings">
            <app-settings layout-active="default"
                          :layout-location="{
      'default': 'databuku.html',
      'fixed': 'fixed-databuku.html',
      'fluid': 'fluid-databuku.html',
      'mini': 'mini-databuku.html'
    }"></app-settings>
        </div>
