                                ...
                                <div class="flex">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="/historydenda">History Denda</a></li>
                                            <li class="breadcrumb-item active"
                                                aria-current="page">Edit History</li>
                                        </ol>
                                    </nav>
                                    <h1 class="m-0">Edit History</h1><br>
                                    <a href="/historydenda"type="button"class="btn btn-primary">Kembali</a>
                                </div>
