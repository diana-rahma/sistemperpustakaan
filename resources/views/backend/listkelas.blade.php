                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active"
                                                aria-current="page">Data Kelas</li>
                                        </ol>
                                    </nav>
                                    <h1 class="m-0">Data Kelas</h1>
                                </div>
                                <a href="/tambah_kelas"
                                   class="btn btn-success ml-3">Tambah Kelas <i class="material-icons">add</i></a>
                            </div>
                        </div>
                                    ...
                                    <table class="table mb-0 thead-border-top-0 table-striped">
                                        ...
                                        <tbody class="list"
                                            ...
                                            <tr>
                                                ...
                                                <td>A</td>
                                                <td>
                                                    <a href="/edit_kelas" type="button" class="btn btn-warning">Edit</a>
                                                    <a href="/delete_kelas"type="button" class="btn btn-danger">Delete</a>         
                                                </td>
                                            </tr>
