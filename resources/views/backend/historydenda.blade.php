    ...
    <body class="layout-default">
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active"
                                                aria-current="page">History Denda</li>
                                        </ol>
                                    </nav>
                                    <h1 class="m-0">History Denda</h1>
                                </div>
                                <a href="/tambah_history"
                                   class="btn btn-success ml-3">Tambah History<i class="material-icons">add</i></a>
                            </div>
                        </div>
        ...
        <div id="app-settings">
            <app-settings layout-active="default"
                          :layout-location="{
      'default': 'historydenda.html',
      'fixed': 'fixed-historydenda.html',
      'fluid': 'fluid-historydenda.html',
      'mini': 'mini-historydenda.html'
    }"></app-settings>
        </div>
