                                ...
                                <div class="flex">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="/mistery">Mistery</a></li>
                                            <li class="breadcrumb-item active"
                                                aria-current="page">Book</li>
                                        </ol><br>
                                        <a href="/mistery"type="button"class="btn btn-primary">Kembali</a>
                                    </nav>
                                </div>
                            ...
                            <div class="card card-form">
                                <div class="row no-gutters">
                                    <div class="col-lg-4 card-body">
                                        <img src="images/stories/misteri1.jpg" style="width: 250px; height: 250px;">
                                    ...
                                    <div class="col-lg-8 card-form__body card-body">
                                        <label for="fname"><h6 class="text-muted">Judul Buku :</h6><h6>Holy Mother</h6></label><br>
                                        <label for="fname"><h6 class="text-muted">Pengarang :</h6><h6>Akiyoshi Rikako</h6></label><br>
                                        <label for="fname"><h6 class="text-muted">Penerbit :</h6><h6>Penerbit Haru</h6></label><br>
                                        <label for="fname"><h6 class="text-muted">Tahun :</h6><h6>2016</h6></label><br>
                                        <label for="fname"><h6 class="text-muted">Lokasi :</h6></label><br>
                                        <label for="fname"><h6 class="text-muted">Kategori :</h6><h6>Mistery</h6></label><br>
