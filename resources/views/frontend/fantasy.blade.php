                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active"
                                                aria-current="page">Fantasy</li>
                                        </ol>
                                    </nav>
                                    <h1 class="m-0">Kategori Fantasy</h1>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/themagiclibrary"><img src="images/stories/themagiclibrary.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/themagiclibrary">The Magic Library</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/neverwhere"><img src="images/stories/neverwhere.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/neverwhere">Neverwhere</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/retrace"><img src="images/stories/retrace.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/retrace">
                                                Retrace</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/tokillawitch"><img src="images/stories/fantasy-tokillawitch.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/tokillawitch">To Kill A Witch</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/harrypotter"><img src="images/stories/harrypotter.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/harrypotter">Harry Potter</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/tujuhkelana"><img src="images/stories/tujuhkelana.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/tujuhkelana">Tujuh Kelana</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/thequeenofthetearling"><img src="images/stories/thequeenofthetearling.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/thequeenofthetearling">The Queen Of The Tearling</a></h4>
                                        </div>
                                    </div>
                                </div>
                        </div>
