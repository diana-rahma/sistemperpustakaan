                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active"
                                                aria-current="page">Biography</li>
                                        </ol>
                                    </nav>
                                    <h1 class="m-0">Kategori Biography</h1>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/thebookofalmost"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/sebatasmimpi"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/sebatasmimpi">Sebatas Mimpi</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/sembilu"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/sembilu">Sembilu</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/criticaleleven"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/criticaleleven">Critical Eleven</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/badromance"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/badromance">Bad Romance</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/lovetohateyou"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/lovetohateyou">Love To Hate You</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/onedayindecember"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/onedayindecember">One Day In December</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="card stories-card-popular">
                                        <a href="/iwanttoeatyourpancreas"><img src="images/stories/.jpg" alt="" class="card-img"></a>
                                        <div class="stories-card-popular__title card-body">
                                            <h4 class="card-title m-0"><a href="/iwanttoeatyourpancreas">i Want To Eat Your Pancreas</a></h4>
                                        </div>
                                    </div>
                                </div>
                        </div>
